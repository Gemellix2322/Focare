      ...
      <div className="container mx-auto grid lg:grid-cols-2 min-h-screen">
        ...
        <div className="hidden lg:flex flex-col justify-center p-12">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8">
            <FeatureCard icon={<Code className="w-8 h-8 text-blue-600" />} title="IA Personalizada" description="Algoritmos inteligentes que se adaptam ao seu ritmo" />
            <FeatureCard icon={<Target className="w-8 h-8 text-blue-600" />} title="Metas Inteligentes" description="Defina e acompanhe objetivos baseados em dados" />
            <FeatureCard icon={<Book className="w-8 h-8 text-blue-600" />} title="Gestão Completa" description="Organize matérias, horários e progresso" />
            <FeatureCard icon={<BarChart className="w-8 h-8 text-blue-600" />} title="Análise de Performance" description="Relatórios detalhados do seu desempenho" />
          </div>
        </div>
          ...
          <Card className="w-full max-w-md shadow-2xl rounded-2xl">
            ...
            <div className="px-6 pb-2">
              <div className="flex border border-gray-200 rounded-lg p-1 mb-6 bg-gray-50">
                <Button className="w-1/2 bg-white shadow-sm text-blue-600 font-semibold hover:text-white" onClick={() => setAuthMode('login')}>Entrar</Button>
                <Button className="w-1/2 text-gray-500 bg-stone-100" onClick={() => setAuthMode('signup')}>Cadastrar</Button>
              </div>
            </div>
